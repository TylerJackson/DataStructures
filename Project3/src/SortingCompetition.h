...
class SortingCompetition {
	...
	void sortData();
	/*
	 	 //char ** quick sort function declarations
	void quickSortAlp(char ** temp,int left, int right);
	void quickSortNum(char ** temp,int left, int right);

		//char ** merge sort function declarations
	void mergeAlp(char ** input, int left, int right, char **storage);
	void mergeSortAlp(char ** input, int start,int finishIndex);
	void mergeNum(char ** input, int left, int right, char **storage);
	void mergeSortNum(char ** input, int size);

		//string * merge function declarations
	void mergeAlp(string * input, int left, int right, string *storage);
	void mergeSortAlp(string * input, int start,int finishIndex);
	void mergeNum(string * input, int left, int right, string *storage);
	void mergeSortNum(string * input, int size);
*/
		//string * quick sort function declarations
	//string * quick sort function declarations
	void quickSortAlp(string * temp,int left, int right);
	void quickSortNum(string* temp,int left, int right);
/*
	void makeHeap(string * temp, int startIndex, int finishIndex);
	void sortHeap(string * temp, int startIndex, int finishIndex);
	void makeHeapNum(string * temp, int size);
	void sortHeapNum(string * temp, int size);
*/
